...
export const metadata: Metadata = { title: 'Careers at HandySolver | Bring your curious side', description: 'Good people. Useful work. Explore life at HandySolver in Gurugram and find your next opportunity.', alternates: { canonical: '/careers' }, openGraph: { title: 'Careers at HandySolver | Bring your curious side', description: 'Good people. Useful work. Explore life at HandySolver in Gurugram and find your next opportunity.', url: '/careers' } };
const jobs = '/careers/open-roles';

export default function Careers() {
  return <div className="handy-home playful-careers"><BreadcrumbsJsonLd items={[{ name: 'Home', path: '/' }, { name: 'Careers', path: '/careers' }]} /><HomeMotion/><a href="#main" className="hp-skip">Skip to content</a><PlayfulHeader/>
    <main id="main">
      <section className="pc-hero hp-wrap"><div><p className="hp-overline"><span/> CAREERS AT HANDYSOLVER</p><h1>Bring your<br/><em>curious side.</em></h1><p className="pc-lede">The questions. The half-formed ideas. The “what if we tried this?”<br/>There’s room for all of it here.</p><div className="pc-actions"><a className="hp-button" href={jobs}>Find your next thing <ArrowUpRight size={19}/></a><a className="pc-link" href="/team">Meet your kind of people <ArrowUpRight size={17}/></a></div><p className="pc-location"><MapPin size={14}/> Made of people. Based in Gurugram.</p></div><div className="pc-scrapbook"><span className="pc-note">Good work.<br/><em>Better company.</em></span><figure className="pc-polaroid"><CareerPhoto priority src="https://handysolver.com/assets/images/rock-n-roll/foosball-short.jpg" alt="HandySolver team members enjoying foosball at the office"/><figcaption>Not every good idea happens at a desk. ↗</figcaption></figure><span className="pc-sticker">People first.<br/>Always.</span><p className="pc-photo-caption">A little glimpse of life here ↖</p></div></section>
