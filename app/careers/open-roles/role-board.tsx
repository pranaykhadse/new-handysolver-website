...
import JobPostingJsonLd from './jobposting-jsonld';
...
export default function RoleBoard(){
  ...
  return <section className="or-board" aria-label="Current openings" aria-busy={state==='loading'}>
    ...
    <div className="or-feed-note"><span>Listings loaded from our recruitment portal. Availability can change.</span></div>
