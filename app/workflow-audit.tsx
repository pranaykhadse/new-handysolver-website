...
const questions = [
  ...
  { name: 'Connected tools', title: 'How often does the same detail travel?', hint: 'Think customer details, orders, invoices or employee records.',
    options: ['We retype the same details in several places.', 'Copy-paste is a regular part of the job.', 'Most tools connect, but a few gaps remain.', 'Details flow between tools with checks in place.'],
